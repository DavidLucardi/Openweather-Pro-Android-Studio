package com.example.davidyl.openweather_pro_davidyl;
...
public class MainActivity extends AppCompatActivity {
    ...
    EditText edittext ;
    Button cari;
    TextView cuaca, suhu, tekanan, kelembaban, degAngin, kecAngin;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        edittext = (EditText) findViewById(R.id.kota);
        cari = (Button) findViewById(R.id.cari);
        cuaca = (TextView) findViewById(R.id.cuaca);
        suhu = (TextView) findViewById(R.id.suhu);
        tekanan = (TextView) findViewById(R.id.tekanan);
        kelembaban = (TextView) findViewById(R.id.lembab);
        ...
        cari.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                final String input = edittext.getText().toString() + ",id" + "&appid=1347dff97a3310a6386afb1a8d3b0a8e";
    ...
    private class  JSONParser extends AsyncTask<String,Void,String> {
        ...
        protected void onPostExecute(String data) {
            ...
            try {
                ...
                kelembaban.setText(""+mainobjek.getInt("humidity") + "%");
